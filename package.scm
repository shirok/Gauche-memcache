;;
;; Package Gauche-memcache
;;

(define-gauche-package "Gauche-memcache"
  ...
  ;; summary.
  :description "Memcached client for Gauche"
  ...
  :providing-modules (memcache)

  ;; List name and contact info of authors.
  ;; e.g. ("Eva Lu Ator <eval@example.com>"
  ;;       "Alyssa P. Hacker <lisper@example.com>")
  :authors ("Takeshi Abe <tabe@fixedpoint.jp>")
  ...
  ;; Homepage URL, if any.
  :homepage "https://fixedpoint.jp/gauche-memcache/"
  )
